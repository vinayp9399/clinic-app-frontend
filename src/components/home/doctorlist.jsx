...
const Doctorlist=()=>{
    ...
    return(
        ...
        <div class="doctor_banner"><div class="docbancont"><div style={{position:"relative",textAlign:"center",top:"217px",left:"277px",height:"176px",width: "747px",fontSize:"21px",backgroundColor:"white",padding: "8px",opacity:"0.5",borderRadius:"20px"}}></div><h2 style={{margin:"0px",position:"relative",top:"64px",fontSize:"41px",color:"black",zIndex:3}}>Book Our Doctors</h2>
        <div style={{position:"relative",top:"88px",left:"350px",display:"flex", gap:"10px", width: "610px",height: "49px"}}>
