...
const Doctorprofile=()=>{
    ...
    const handleSubmit = async (e) => {
      ...
      axios.put(`http://clinic-app-backend.vercel.app/image/${id}`,imageData,config).then((response)=>{
        console.log(response);
      })
        // axios.put(`http://clinic-app-backend.vercel.app/users/updateimage/${id}`,imageData).then((response)=>{
        //     //console.log(response)
