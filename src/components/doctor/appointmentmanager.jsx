...
const Appointmentmanager=()=>{
    ...
    const patientDetails=(phoneno)=>{
       localStorage.setItem("patientdetphone",phoneno);
                    ...
                    <td colSpan={7}>
                        ...
                        {showpatients===true &&
                                 ...
                                 <tr>
                                        ...
                                        <input class="btn-primary-soft btn button-icon btn-view" style={{marginTop:"5px",marginLeft:"10px"}} onClick={()=>patientDetails(data1.phoneno)} type='button' value="Details" />
                                        </td>
                                    </tr>
                                     ))}</>}
